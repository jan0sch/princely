...
Rendering to a string and passing it to prince is no longer done because
that broke almost all unicode stuff. Now the url for the current controller
action is passed to prince. Therefore you need to keep sure that this url
is accessible from the prince application.
